export default function Contact() {
  return (
    <section
      id="contact"
      className="px-4 py-20 border-t border-border bg-linear-to-t from-primary-soft to-primary"
    >
      <div className="mx-auto max-w-5xl text-center space-y-6">
        <h2 className="text-2xl font-semibold text-text">Let&apos;s work together</h2>
        <p className="max-w-xl mx-auto text-sm text-muted">
          Looking for a skilled mobile developer for your iOS or Android project? 
          I&apos;m open to remote freelance, contract work, and long-term collaborations.
        </p>
        <a
